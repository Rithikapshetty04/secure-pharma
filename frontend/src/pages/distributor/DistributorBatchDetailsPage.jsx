  ...
  if (error || !batch) {
    return (
      <div className="glass-card" style={{ maxWidth: '600px', margin: '40px auto', padding: '30px', textAlign: 'center', background: '#ffffff' }}>
        ...
        <Link to="/distributor/batches" className="btn btn-outline btn-sm" style={{ marginTop: '16px' }}>
          ← Back to Batches
        </Link>
      </div>
    );
      ...
      <div className="glass-card" style={{ padding: '32px', marginBottom: '28px', background: '#ffffff' }}>
        ...
        >
          ...
          <div style={{ textAlign: 'right' }}>
            <div style={{ fontSize: '0.75rem', color: 'var(--text-dim)', fontWeight: '700' }}>AVAILABLE QUANTITY</div>
